...
void HRTIM_Config(void)
{
  ...
  HRTIM_TIM_OutputStructure.ResetSource = HRTIM_OUTPUTRESET_TIMCMP1|HRTIM_OUTPUTRESET_EEV_6; //计数到CMP1寄存器值，输出拉低
  ...
  HRTIM_DeadTimeConfig(HRTIM1, HRTIM_TIMERINDEX_TIMER_A, &HRTIM_TIM_DeadTimeStructure);            //开始配置定时器A
	HRTIM_TIM_DeadTimeStructure.FallingValue = 0;                                                    //下降沿死区时间
	HRTIM_TIM_DeadTimeStructure.RisingValue = 0;                                                     //上升沿死区时间
